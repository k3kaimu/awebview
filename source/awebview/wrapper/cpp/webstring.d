...
mixin template Awesomium4D()
{
    extern(C++, WebStringMember)
    {
        ...
        void ctor(Awesomium.WebString p, const(wchar)* data);
        void ctor(Awesomium.WebString p, const(wchar)* data, uint len);
        ...
        Awesomium.WebString newCtor(const(wchar)* data);
        Awesomium.WebString newCtor(const(wchar)* data, uint len);
        ...
        const(wchar)* data(const Awesomium.WebString p);
        ...
        Awesomium.WebString Assign(Awesomium.WebString p, const(wchar)* data);
        Awesomium.WebString Assign(Awesomium.WebString p, const(wchar)* data, uint len);
